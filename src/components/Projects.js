        ...
        <div style={styles.projects}>
            <div style={styles.flex}>
                <div className="project-container">
                    <a href="https://github.com/jrgartner/Team-Profile-Generator" target="_blank" rel="noreferrer" style={styles.fit}>
                    <img src={require('../images/teamProfile.png')}  alt="Team Profile Generator" />style={styles.img}/>
                    </a>
                ...
                <div className="project-container">
                    <a href="https://github.com/jrgartner/Crime-Watch" target="_blank" rel="noreferrer" style={styles.fit}>
                    <img src={require('../images/crimeWatch.png')}  alt="E-Commerce" style={styles.img}/>
                    </a>
                    <div style={styles.title}>
                ...
                <div className="project-container">
                    <a href="https://github.com/jrgartner/Note-Taker" target="_blank" rel="noreferrer" style={styles.fit}>
